...
[`@aws-sdk/signature-v4-multi-region`](https://www.npmjs.com/package/@aws-sdk/signature-v4-multi-region/v/3.996.29).
...
- @aws-sdk/signature-v4-multi-region - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region)
- @aws-sdk/signature-v4-multi-region v3.996.29 - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.29](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.29)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.29/index.min.mjs
```

SRI SHA Hash

```text
sha384-lG1Ea2QDz7ptKRstU9MOJDYKix/mss78owrGIugF0cuvPPeoImVtSiN00btT5SFz
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/signature-v4-multi-region": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.29/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.29/index.min.mjs": "sha384-lG1Ea2QDz7ptKRstU9MOJDYKix/mss78owrGIugF0cuvPPeoImVtSiN00btT5SFz"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/signature-v4-multi-region";
...
* Always pin to a specific version (`@3.996.29`)
...
```
https://github.com/cloud-sdk-builds/signature-v4-multi-region/blob/refs/tags/3.996.29/LICENSE
```
