...
[`@aws-sdk/signature-v4-multi-region`](https://www.npmjs.com/package/@aws-sdk/signature-v4-multi-region/v/3.996.37).
...
- @aws-sdk/signature-v4-multi-region v3.996.37 - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.37](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.37)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.37/index.min.mjs
```

SRI SHA Hash

```text
sha384-saUP2Oa49W4ssZ5QyVjrtC36u5lRHZ80t9YvwLrWXO8/5GFSC9pKMjxMuFPHso4Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/signature-v4-multi-region": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.37/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.37/index.min.mjs": "sha384-saUP2Oa49W4ssZ5QyVjrtC36u5lRHZ80t9YvwLrWXO8/5GFSC9pKMjxMuFPHso4Z"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.996.37`)
...
```
https://github.com/cloud-sdk-builds/signature-v4-multi-region/blob/refs/tags/3.996.37/LICENSE
```
