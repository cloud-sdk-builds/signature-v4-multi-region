...
[`@aws-sdk/signature-v4-multi-region`](https://www.npmjs.com/package/@aws-sdk/signature-v4-multi-region/v/3.996.26).
...
- @aws-sdk/signature-v4-multi-region v3.996.26 - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.26](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.26)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.26/index.min.mjs
```

SRI SHA Hash

```text
sha384-vfZlNKWO6BKD9dKedLog+vxYCy29vdQRhSx/G5DUbrkX3TTD7OHPn+6eOULOe9J5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/signature-v4-multi-region": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.26/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.26/index.min.mjs": "sha384-vfZlNKWO6BKD9dKedLog+vxYCy29vdQRhSx/G5DUbrkX3TTD7OHPn+6eOULOe9J5"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.996.26`)
...
```
https://github.com/cloud-sdk-builds/signature-v4-multi-region/blob/refs/tags/3.996.26/LICENSE
```
