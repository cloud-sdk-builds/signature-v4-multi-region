...
[`@aws-sdk/signature-v4-multi-region`](https://www.npmjs.com/package/@aws-sdk/signature-v4-multi-region/v/3.996.45).
...
- @aws-sdk/signature-v4-multi-region v3.996.45 - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.45](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.45)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.45/index.min.mjs
```

SRI SHA Hash

```text
sha384-vn26+Y8/XSwWgX7ONkN0bmT9zJLCW4FNn6o1J/UEbedkhab5/fVStRKm5+ZbB4G4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/signature-v4-multi-region": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.45/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.45/index.min.mjs": "sha384-vn26+Y8/XSwWgX7ONkN0bmT9zJLCW4FNn6o1J/UEbedkhab5/fVStRKm5+ZbB4G4"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.996.45`)
...
```
https://github.com/cloud-sdk-builds/signature-v4-multi-region/blob/refs/tags/3.996.45/LICENSE
```
