...
[`@aws-sdk/signature-v4-multi-region`](https://www.npmjs.com/package/@aws-sdk/signature-v4-multi-region/v/3.996.34).
...
- @aws-sdk/signature-v4-multi-region v3.996.34 - [https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.34](https://cloud-sdk-builds.github.io/?sdk=signature-v4-multi-region&version=3.996.34)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.34/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/signature-v4-multi-region": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.34/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/signature-v4-multi-region@3.996.34/index.min.mjs": "sha384-lG1Ea2QDz7ptKRstU9MOJDYKix/mss78owrGIugF0cuvPPeoImVtSiN00btT5SFz"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.996.34`)
...
```
https://github.com/cloud-sdk-builds/signature-v4-multi-region/blob/refs/tags/3.996.34/LICENSE
```
